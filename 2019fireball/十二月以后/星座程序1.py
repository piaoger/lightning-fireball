...
class CLS_star(object):
  def __init__(self,name,month1,day1,month2,day2,likeList,hateList):
      self.name=name
      self.month1=month1
      self.day1=day1
      self.month2=month2
...
st00=CLS_star('白羊',3,21,4,19,[3,4,7],[6,2,8])
starList.append(st00)
st01=CLS_star('金牛',4,20,5,20,[4,9,8],[2,3,7])
starList.append(st01)
st02=CLS_star('双子',5,21,6,21,[0,1,10],[4,6,8])
starList.append(st02)
st03=CLS_star('巨蟹',6,22,7,22,[11,7,5],[4,2,1])
starList.append(st03)
st04=CLS_star('狮子',7,23,8,22,[2,6,8],[5,2,0])
starList.append(st04)
st05=CLS_star('处女',8,23,9,22,[10,3,11],[4,9,8])
starList.append(st05)
st06=CLS_star('天秤',9,23,10,23,[5,11,7],[3,1,9])
starList.append(st06)
st07=CLS_star('天蝎',10,24,11,22,[9,6,0],[5,3,1])
starList.append(st07)
st08=CLS_star('射手',11,23,12,21,[1,6,11],[9,10,2])
starList.append(st08)
st09=CLS_star('摩羯',12,22,1,19,[1,4,8],[10,7,3])
starList.append(st09)
st10=CLS_star('水瓶',1,20,2,18,[3,5,9],[4,7,8])
starList.append(st10)
st11=CLS_star('双鱼',2,19,3,20,[1,2,6],[3,2,1])
...
while True:
  ...
  if starList[star2Index].likeList[0] == star1Index:
      ...
      print('soso')
  elif starList[star2Index].hateList[0] == star1Index:
      print('那个人觉得你去死')
  elif starList[star2Index].hateList[1] == star1Index:
      print('那个人觉得脑子有肯')
  elif starList[star2Index].hateList[2] == star1Index:
      print('soso，shit')
  else:
    print('呵呵,hh')
  break  
